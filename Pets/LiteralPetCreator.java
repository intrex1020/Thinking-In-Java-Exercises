...
public class LiteralPetCreator extends PetCreator
{
	...
	private static final List<Class<? extends Pet>> types = LiteralPetCreator.allTypes
			.subList(LiteralPetCreator.allTypes.indexOf(Mutt.class), LiteralPetCreator.allTypes.size());

	@Override
	public List<Class<? extends Pet>> types()
	{
		return LiteralPetCreator.types;
	}

	public static void main(String[] args)
	{
		System.out.println(LiteralPetCreator.types);
	}
} /*
